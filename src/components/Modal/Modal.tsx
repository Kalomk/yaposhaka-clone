...
const Modal = () => {
  ...
  return (
    <div
      ...
      className={
        active
          ? 'b24-widget-button-wrapper b24-widget-button-position-bottom-left b24-widget-button-visible active'
    ...
    >
      <div
        ...
        style={{ borderColor: '#ef008b' }}
      >
        <span data-b24-hello-btn-hide="" className="b24-widget-button-popup-btn-hide"></span>
        <div className="b24-widget-button-popup-inner">
          <div className="b24-widget-button-popup-image">
            <span data-b24-hello-icon="" className="b24-widget-button-popup-image-item"></span>
          </div>
          <div className="b24-widget-button-popup-content">
            <div data-b24-hello-name="" className="b24-widget-button-popup-name"></div>
            <div data-b24-hello-text="" className="b24-widget-button-popup-description"></div>
          </div>
        </div>
        <div className="b24-widget-button-popup-triangle" style={{ borderColor: '#ef008b' }}></div>
      </div>
      ...
      <div data-b24-crm-button-block="" className="b24-widget-button-social">
        <a
          ...
          style={{
            backgroundColor: 'rgb(239, 0, 139)',
          }}
        >
          <i></i>
          <span data-b24-crm-button-tooltip="" className="b24-widget-button-social-tooltip">
            Онлайн чат Call Center
          </span>
        </a>
        <a
          className="b24-widget-button-social-item ui-icon ui-icon-service-viber connector-icon-45"
          data-b24-widget-sort="400"
          href="viber://pa?chatURI=yaposhkacallcenter"
          target="_blank"
        >
          <i></i>
          <span data-b24-crm-button-tooltip="" className="b24-widget-button-social-tooltip">
            Yaposhka Call Center
          </span>
        </a>
        <a
          className="b24-widget-button-social-item ui-icon ui-icon-service-telegram connector-icon-45"
          title=""
          data-b24-widget-sort="400"
          href="https://t.me/Yaposhka_Call_Center_bot"
          target="_blank"
        >
          <i></i>
          <span data-b24-crm-button-tooltip="" className="b24-widget-button-social-tooltip">
      ...
      <div data-b24-crm-button-block-button="" className="b24-widget-button-inner-container">
        <div
